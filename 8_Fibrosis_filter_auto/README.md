This module allows to remove false positive particles from the fibrosis selection. It is based on a size filter over a binary mask (e.g., output of module 7).
